 ...
 * {@link HCTHomeFragement.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HCTHomeFragement#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HCTHomeFragement extends Fragment implements HCTHomeAdapter.OnAdapterItemClick {
     ...
     * @return A new instance of fragment HCTHomeFragement.
     */
    // TODO: Rename and change types and number of parameters
    public static HCTHomeFragement newInstance(String param1, String param2) {
        HCTHomeFragement fragment = new HCTHomeFragement();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_hcthome_fragement, container, false);
    ...
    private void createHomeItems() {
        for (int i =0;i< home_items.length; i++){
            ...
            items.setHomeImage(home_items_images.getResourceId(i, -1));
            homeItems.add(items);
    ...
    public void onItemClick(int position) {
      ...
      switch (position){
          case 0:
              fragment= new HCTStudent_fragment();
              break;
          case 1:
              break;
          case 2:
